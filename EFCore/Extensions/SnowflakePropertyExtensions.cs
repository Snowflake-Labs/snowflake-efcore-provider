...
/// <summary>
///     Property extension methods for Snowflake-specific metadata.
/// </summary>
/// <remarks>
...
public static class SnowflakePropertyExtensions
{
    ...
    public static string? GetHiLoSequenceName(this IReadOnlyProperty property)
        => (string?)property[SnowflakeAnnotationNames.HiLoSequenceName];
    ...
    {
        var annotation = property.FindAnnotation(SnowflakeAnnotationNames.HiLoSequenceName);
        if (annotation != null)
        {
    ...
    public static ConfigurationSource? GetHiLoSequenceNameConfigurationSource(this IConventionProperty property)
        => property.FindAnnotation(SnowflakeAnnotationNames.HiLoSequenceName)?.GetConfigurationSource();
    ...
    public static string? GetHiLoSequenceSchema(this IReadOnlyProperty property)
        => (string?)property[SnowflakeAnnotationNames.HiLoSequenceSchema];
    ...
    {
        var annotation = property.FindAnnotation(SnowflakeAnnotationNames.HiLoSequenceSchema);
        if (annotation != null)
        {
            return (string?)annotation.Value;
        }
    ...
    public static ConfigurationSource? GetHiLoSequenceSchemaConfigurationSource(this IConventionProperty property)
        => property.FindAnnotation(SnowflakeAnnotationNames.HiLoSequenceSchema)?.GetConfigurationSource();
    ...
    public static string? GetSequenceSchema(this IReadOnlyProperty property)
        => (string?)property[SnowflakeAnnotationNames.SequenceSchema];
    ...
    public static long? GetIdentitySeed(this IReadOnlyRelationalPropertyOverrides overrides)
        => overrides is RuntimeRelationalPropertyOverrides
            ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
            : (long?)overrides.FindAnnotation(SnowflakeAnnotationNames.IdentitySeed)?.Value;
    ...
    public static long? SetIdentitySeed(
        ...
        long? seed,
        bool fromDataAnnotation = false)
        => (long?)overrides.SetOrRemoveAnnotation(SnowflakeAnnotationNames.IdentitySeed, seed, fromDataAnnotation)?.Value;
    ...
    public static int? GetIdentityIncrement(this IReadOnlyProperty property)
        => (property is RuntimeProperty)
            ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
            : (int?)property[SnowflakeAnnotationNames.IdentityIncrement]
    ...
    public static int? GetIdentityIncrement(this IReadOnlyRelationalPropertyOverrides overrides)
        => overrides is RuntimeRelationalPropertyOverrides
            ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
            : (int?)overrides.FindAnnotation(SnowflakeAnnotationNames.IdentityIncrement)?.Value;
    ...
    public static int? SetIdentityIncrement(
        ...
        int? increment,
        bool fromDataAnnotation = false)
        => (int?)overrides.SetOrRemoveAnnotation(SnowflakeAnnotationNames.IdentityIncrement, increment, fromDataAnnotation)
            ?.Value;
    ...
    /// <summary>
    ///     Returns the <see cref="SnowflakeValueGenerationStrategy" /> to use for the property.
    /// </summary>
    /// <remarks>
    ///     If no strategy is set for the property, then the strategy to use will be taken from the <see cref="IModel" />.
    /// </remarks>
    /// <param name="property">The property.</param>
    /// <returns>The strategy, or <see cref="SnowflakeValueGenerationStrategy.None" /> if none was set.</returns>
    ...
    {
        var @override = property.FindOverrides(storeObject)?.FindAnnotation(SnowflakeAnnotationNames.ValueGenerationStrategy);
        if (@override != null)
        {
    ...
    private static SnowflakeValueGenerationStrategy GetDefaultValueGenerationStrategy(IReadOnlyProperty property)
    {
        ...
        if (modelStrategy is SnowflakeValueGenerationStrategy.SequenceHiLo or SnowflakeValueGenerationStrategy.Sequence
            && IsCompatibleWithValueGeneration(property))
        {
            return modelStrategy.Value;
        }

        return modelStrategy == SnowflakeValueGenerationStrategy.IdentityColumn
            && IsCompatibleWithValueGeneration(property)
                ? SnowflakeValueGenerationStrategy.IdentityColumn
                : SnowflakeValueGenerationStrategy.None;
    }
        ...
        return modelStrategy == SnowflakeValueGenerationStrategy.IdentityColumn
            && IsCompatibleWithValueGeneration(property, storeObject, typeMappingSource)
                ? property.DeclaringType.GetMappingStrategy() == RelationalAnnotationNames.TpcMappingStrategy
                    ? SnowflakeValueGenerationStrategy.Sequence
                    : SnowflakeValueGenerationStrategy.IdentityColumn
                : SnowflakeValueGenerationStrategy.None;
    }

    /// <summary>
    ///     Sets the <see cref="SnowflakeValueGenerationStrategy" /> to use for the property.
    /// </summary>
    /// <param name="property">The property.</param>
    ...
    private static SnowflakeValueGenerationStrategy? CheckValueGenerationStrategy(
        IReadOnlyProperty property,
        SnowflakeValueGenerationStrategy? value)
    {
        if (value == null)
        ...
        if (value == SnowflakeValueGenerationStrategy.IdentityColumn
            && !IsCompatibleWithValueGeneration(property))
        {
        ...
        if (value is SnowflakeValueGenerationStrategy.SequenceHiLo or SnowflakeValueGenerationStrategy.Sequence
            && !IsCompatibleWithValueGeneration(property))
        {
            throw new ArgumentException(
    ...
    /// <summary>
    ///     Returns a value indicating whether the property is compatible with any <see cref="SnowflakeValueGenerationStrategy" />.
    /// </summary>
    /// <param name="property">The property.</param>
