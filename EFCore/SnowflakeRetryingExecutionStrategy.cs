...
/// <summary>
///     An <see cref="IExecutionStrategy" /> implementation for retrying failed executions on Snowflake.
/// </summary>
/// <remarks>
///     <para>
...
///     </para>
/// </remarks>
public class SnowflakeRetryingExecutionStrategy : ExecutionStrategy
{
    ...
    protected override bool ShouldRetryOn(Exception exception)
    {
        if (_additionalErrorNumbers != null
            && exception is SnowflakeDbException SnowflakeDbException)
        {
            /*
            foreach (SqlError err in SnowflakeDbException.Errors)
            {
        ...
        return SnowflakeTransientExceptionDetector.ShouldRetryOn(exception);
    }
    ...
    {
        if (exception is SnowflakeDbException SnowflakeDbException)
        {
            return false;
/*
                foreach (SqlError err in SnowflakeDbException.Errors)
