...
namespace Snowflake.EntityFrameworkCore.FunctionalTests.TestModels.ComplexTypeData;

#nullable enable

public class SnowflakeComplexTypeData : ISetSource
{
    ...
    public SnowflakeComplexTypeData()
    {
